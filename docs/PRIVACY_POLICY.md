...
- **Profile Avatars**: Profile images you upload for collaboration features (compressed to 512x512 pixels)
...
- **Profile Avatar**: Optional profile image for collaboration features
...
- **Background Processing**: Backups run in the background with notification when complete
...
Home Staff 360 offers optional premium subscriptions:

- **Monthly and Annual Plans**: Choose the billing cycle that works for you
- **5-Tier Regional Pricing**: Fair pricing across 173 countries
- **Google Play Billing**: Secure payment processing through Google Play

### 7.2 Subscription Data

- Subscription status is managed through Google Play
- We do not store your payment card details
- Subscription receipts are verified securely
...
- **Push Notifications**: Secure Firebase Cloud Messaging for Android
...
| Notifications | Receive alerts for messages and updates |
...
### 12.2 Limited Access Circumstances
...
*Home Staff 360 v3.0 - Your Data, Your Device, Your Control*
