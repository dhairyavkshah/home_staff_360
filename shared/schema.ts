...
// Subscription pricing for different regions (~$10 USD equivalent, India: ₹300/year)
export const SUBSCRIPTION_PRICES = {
  INR: { amount: 300, currency: 'INR', country: 'IN' },
  USD: { amount: 10, currency: 'USD', country: 'US' },
  EUR: { amount: 9, currency: 'EUR', country: 'EU' },
  GBP: { amount: 8, currency: 'GBP', country: 'GB' },
  AUD: { amount: 15, currency: 'AUD', country: 'AU' },
  CAD: { amount: 14, currency: 'CAD', country: 'CA' },
  CHF: { amount: 9, currency: 'CHF', country: 'CH' },
  CZK: { amount: 230, currency: 'CZK', country: 'CZ' },
  DKK: { amount: 70, currency: 'DKK', country: 'DK' },
  HKD: { amount: 80, currency: 'HKD', country: 'HK' },
  HUF: { amount: 3700, currency: 'HUF', country: 'HU' },
  ILS: { amount: 37, currency: 'ILS', country: 'IL' },
  JPY: { amount: 1500, currency: 'JPY', country: 'JP' },
  MXN: { amount: 170, currency: 'MXN', country: 'MX' },
  NOK: { amount: 110, currency: 'NOK', country: 'NO' },
  NZD: { amount: 17, currency: 'NZD', country: 'NZ' },
  PHP: { amount: 580, currency: 'PHP', country: 'PH' },
  PLN: { amount: 40, currency: 'PLN', country: 'PL' },
  RUB: { amount: 950, currency: 'RUB', country: 'RU' },
  SEK: { amount: 110, currency: 'SEK', country: 'SE' },
  SGD: { amount: 13, currency: 'SGD', country: 'SG' },
  THB: { amount: 350, currency: 'THB', country: 'TH' },
  TWD: { amount: 320, currency: 'TWD', country: 'TW' },
  AED: { amount: 37, currency: 'AED', country: 'AE' },
  CNY: { amount: 70, currency: 'CNY', country: 'CN' },
  BRL: { amount: 60, currency: 'BRL', country: 'BR' },
  ZAR: { amount: 185, currency: 'ZAR', country: 'ZA' },
} as const;
